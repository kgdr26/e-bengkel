                            ...
                            <tbody>
                                ...
                                @foreach($arr as $key => $value)
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>
                                            <img src="{{asset('assets/images/profiles/'.$value->foto)}}" alt="" class="avatar avatar-xs rounded-circle">
                                        </td>
                                        <td>{{$value->level}}</td>
                                        <td>{{$value->name}}</td>
                                        <td>{{$value->email}}</td>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card-style">
                            <div class="card-foto">
                                <img src="{{asset('assets/images/profiles/default.jpg')}}" alt="user avatar" id="img_add">
                            </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="card-style">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Role</label>
                                <select data-name="edit_role_id" class="form-select select-2-add">
                                    <option value="">-- Select Role --</option>
                                    @foreach($role as $key => $value)
                                        <option value="{{$value->id}}">{{$value->name}}</option>
                                    @endforeach
